...
public class DishTestData {
    ...
    public static final Dish DISH1 = new Dish(DISH1_ID, "Dish1(Rest1)", of(2023, Month.MAY, 1), 0);
    public static final Dish DISH2 = new Dish(DISH2_ID, "Dish2(Rest1)", of(2023, Month.MAY, 1), 0);
    public static final Dish DISH3 = new Dish(DISH3_ID, "Dish3(Rest1)", of(2023, Month.MAY, 1), 0);
    static final Dish DISH4 = new Dish(DISH4_ID, "Dish4(Rest2)", LocalDate.now(), 0);
    static final Dish DISH5 = new Dish(DISH5_ID, "Dish5(Rest2)", LocalDate.now(), 0);
    static final Dish DISH6 = new Dish(DISH6_ID, "Dish6(Rest3)", LocalDate.now(), 0);
    static final Dish DISH7 = new Dish(DISH7_ID, "Dish7(Rest3)", LocalDate.now(), 0);
