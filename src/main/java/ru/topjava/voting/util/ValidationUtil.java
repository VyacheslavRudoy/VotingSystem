...
public class ValidationUtil {
    ...
    private static LocalTime DEADLINE_TIME = LocalTime.of(12, 00);
    ...
    public static void checkIsNew(HasUserId entity) {
        if (!entity.isNew()) {
            throw new IllegalRequestDataException(entity + " should be new (id = null)");
        }
    }

    public static void compatibleId(HasUserId entity, int id) {
        if (entity.isNew()) {
            entity.setId(id);
